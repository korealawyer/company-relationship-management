...
async function run() {
    const { data: companies } = await s.from('companies').select('id, name, biz_no, issue_count').eq('biz_no', '1234567890');
    console.log("Companies with biz_no 1234567890:", companies);
