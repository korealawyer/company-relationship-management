...
export default function ReportsPage() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            // CSV가 필요한 경우 아래 주석 해제하여 동시 처리 가능
            // const csvGenerator = ReportGeneratorFactory.create('CSV', 'REP_PERFORMANCE.csv');
            // await csvGenerator.generate(undefined, REP_PERFORMANCE);
    ...
    return (
        <div className="min-h-screen px-4 py-8 max-w-[1400px] mx-auto" style={{ background: T.bg }}>
            ...
            {/* PDF로 변환될 메인 컨텐츠 영역 */}
            <div ref={reportRef} className="rounded-xl overflow-hidden p-2" style={{ background: T.bg }}>
                {/* KPI 카드 */}
