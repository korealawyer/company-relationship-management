            ...
            <div className="max-w-5xl mx-auto px-4">
                <div className="text-center py-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-4"
                        ...
                        <span className="text-sm font-bold" style={{ color: '#c9a84c' }}>Claude Sonnet 3.7 기반 검토</span>
                    </div>
                    <h1 className="text-3xl font-black mb-2" style={{ color: '#f0f4ff' }}>계약서 리스크 분석</h1>
                    <p className="text-sm" style={{ color: 'rgba(240,244,255,0.5)' }}>계약서를 붙여넣으면 조항별 리스크를 자동 분석합니다</p>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <button onClick={analyze} disabled={loading || !text.trim()}
                            ...
                            {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> 분석 중...</> : <><Bot className="w-5 h-5" /> 리스크 분석</>}
                        </button>
                    </div>
                    <div>
                        <h2 className="font-bold text-sm mb-3" style={{ color: 'rgba(240,244,255,0.7)' }}>분석 결과</h2>
                        {!result && !loading && (
