...
const FAQS: FAQ[] = [
    // 서비스 이용
    { category: '서비스 이용', q: '구독 후 바로 법률 상담을 사용할 수 있나요?', a: '네, 구독 결제 완료 즉시 법률 AI 챗봇과 변호사 자문 서비스를 이용하실 수 있습니다. Pro·Premium 플랜은 전담 변호사가 48시간 이내에 배정됩니다.' },
    { category: '서비스 이용', q: '법률 자문 건수를 초과하면 어떻게 되나요?', a: '월간 자문 건수 초과 시 건당 추가 요금(33만원/건)이 발생합니다. 또는 상위 플랜으로 업그레이드하시면 더 경제적입니다.' },
    { category: '서비스 이용', q: '개인정보 진단 리포트는 얼마나 걸리나요?', a: 'AI 자동 분석은 즉시 제공되며, 변호사 검토 의견이 포함된 정밀 리포트는 영업일 기준 2~3일 소요됩니다.' },
    ...
    // 계정
    { category: '계정', q: '팀원을 추가하려면 어떻게 하나요?', a: '프로필 > 팀원 관리에서 이메일로 초대할 수 있습니다. Basic 플랜은 5명, Pro 이상은 무제한입니다.' },
