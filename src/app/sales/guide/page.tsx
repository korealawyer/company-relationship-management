...
const FAQS = [
    ...
    },
    {
        ...
        a: '/sales/leads에서 해당 고객 → 상태를 "in_contact"로 변경 → 콜 메모에 날짜와 다음 연락 시점 기록 → /sales/call에서 다음 콜 알림 설정. 자동 리마인더가 설정한 날짜에 알림을 보냅니다.',
    },
    {
    ...
    },
    {
        ...
        a: '고객이 플랫폼 구독 후 → 대시보드에서 "법률 자문 요청" → 전담 변호사가 24시간 이내 응답. 영업팀은 /sales/leads에서 해당 고객의 자문 요청 현황을 실시간 확인 가능합니다.',
    },
    {
