                ...
                <div className="max-w-[1920px] mx-auto">
                    ...
                    <div id="tour-stats" className="flex items-center gap-3 mb-2">
                        <div className="flex gap-2 flex-1">
                            {[{ l: '대기', v: Math.max(0, (statusCounts?.all || 0) - calledCount), c: '#4f46e5', b: '#eef2ff' }, 
                              ...
                              { l: '완료율', v: (statusCounts?.all || 0) > 0 ? `${Math.round(calledCount / (statusCounts?.all || 0) * 100)}%` : '0%', c: '#0891b2', b: '#ecfeff' }].map(k => (
