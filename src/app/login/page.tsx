        ...
        >
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
                    <div className="rounded-2xl flex items-center justify-center mx-auto mb-4 font-black text-xl"
                        style={{ background: 'linear-gradient(135deg,#e8c87a,#c9a84c)', color: '#04091a', width: 56, height: 56, letterSpacing: '-1px' }}>
                        IBS
                    </div>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                className="input-navy pl-9 pr-11"
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                className="input-navy pl-9 font-mono tracking-wider"
